...
from modules.surya_order.config import VariableDonutSwinConfig
...
class VariableDonutSwinEmbeddings(DonutSwinEmbeddings):
    ...
    def forward(
        ...
        interpolate_pos_encoding: Optional[torch.BoolTensor] = None
        # **kwargs
        ...
        # print('bool_masked_pos', bool_masked_pos)
